...
if (getenv('ALLOW_SETUP_LIBS') !== '1') { http_response_code(403); echo 'setup-libs is disabled. Set ALLOW_SETUP_LIBS=1 temporarily if needed.'; exit; }
...
function fetch_url($url) {
  ...
  if (ini_get('allow_url_fopen')) {
    $ctx = stream_context_create(['http'=>['timeout'=>120],'ssl'=>['verify_peer'=>true,'verify_peer_name'=>true]]);
